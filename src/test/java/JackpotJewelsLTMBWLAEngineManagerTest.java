...
public class JackpotJewelsLTMBWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(JackpotJewelsLTMBWLAEngineManagerTest.class);
		logger.setLevel(Level.DEBUG);
		gameParams = XMLUtil.parseResource("paymodel/JackpotJewelsLTMBWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/JackpotJewelsLTMBWLAIW/InitOutcome.xml").getDocumentElement();
